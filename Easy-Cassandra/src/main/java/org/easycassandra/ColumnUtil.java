...
import javax.persistence.CustomData;
...
import javax.persistence.ListData;
import javax.persistence.MapData;
import javax.persistence.MappedSuperclass;
import javax.persistence.SetData;
...
enum ColumnUtil {
    ...
    /**
     * Return the Field with the Id Annotations.
     * @see Id
    ...
    public List<FieldInformation> getIndexFields(Class<?> persistenceClass) {
        ...
        if (isMappedSuperclass(persistenceClass)) {
        	indexFieldList.addAll(getIndexFields(persistenceClass.getSuperclass()));
        }
    ...
    public Field getField(Class object, Class annotation) {
        ...
        if (isMappedSuperclass(object)) {
        	return getField(object.getSuperclass(), annotation);
        }
