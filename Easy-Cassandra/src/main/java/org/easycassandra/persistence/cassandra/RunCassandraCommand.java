...
public class RunCassandraCommand {
    ...
    */
    public <T> List<T> findByIndex(String indexName, Object index,
        ...
        return findByIndex(indexName, index, bean, session, 0);
    }
   /**
    * find list of objects from index.
    * @param indexName name of index
    ...
    */
    public <T> List<T> findByIndex(String indexName, Object index,
            Class<T> bean, Session session, int offset) {
        return findByIndex(indexName, index, bean, session,
                DEFAULT_CASSANDRA_CL, offset);
    }
    ...
    public <T> List<T> findByIndex(String indexName, Object index,
        ...
        return findByIndex(indexName, index, bean, session, consistency, 0);
    }
	/**
     * find list of objects from index.
     * @param indexName name of index
     ...
     */
    public <T> List<T> findByIndex(String indexName, Object index,
            Class<T> bean, Session session, ConsistencyLevel consistency, int offset) {
        return findByIndexQuery.findByIndex(indexName, index,
                bean, session, consistency, offset);
    }
    ...
    public <T> List<T> findByIndex(Object index, Class<T> bean,
            Session session,  ConsistencyLevel consistency) {
        return findByIndex(index, bean, session, consistency, 0);
    }
    /**
     * find list of objects from index.
     * The default will be the first field
     ...
     */
    public <T> List<T> findByIndex(Object index, Class<T> bean,
            Session session,  ConsistencyLevel consistency, int offset) {
    ...
    public <T> List<T> findByIndex(Object index, Class<T> bean, Session session) {
        return findByIndex(index, bean, session, 0);
    }
    /**
     * find list of objects from index.
     * The default will be the first field
     ...
     */
    public <T> List<T> findByIndex(Object index, Class<T> bean,
            Session session, int offset) {
        return findByIndex(index, bean, session, DEFAULT_CASSANDRA_CL, offset);
    }
	/**
     * find list of objects from index.
     * The default will be the first field
    ...
    public <T, I> List<T> findByKeyAndIndex(Object key, I index, Class<T> bean,
            Session session) {
        return findByKeyAndIndex(key, index, bean, session, 0);
    }
    /**
     * find list of objects from index.
     * The default will be the first field
    ...
    public <T, I> List<T> findByKeyAndIndex(Object key, I index, Class<T> bean,
        ...
        return findByKeyAndIndex.findByKeyAndIndex(key,
                index, bean, session, DEFAULT_CASSANDRA_CL, offset);
    }
    ...
    public <T, I> List<T> findByKeyAndIndex(Object key, I index, Class<T> bean,
            Session session, ConsistencyLevel consistency) {
        return findByKeyAndIndex(key, index, bean, session, consistency, 0);
    }
    /**
     * Find by primary key and index.
     * @param index the index value
    ...
    public <T, I> List<T> findByKeyAndIndex(Object key, I index, Class<T> bean,
            Session session, ConsistencyLevel consistency, int offset) {
        return findByKeyAndIndex.findByKeyAndIndex(key,
                index, bean, session, consistency, offset);
    }
    ...
    public <T, I> List<T> findByKeyAndIndexRange(Object key, I indexStart,
        ...
        return findByKeyAndIndexRange(key, indexStart, indexEnd, inclusive, 
				bean, session, 0);
    }
    /**
     * Find by primary key and index range.
     ...
     */
    public <T, I> List<T> findByKeyAndIndexRange(Object key, I indexStart,
            I indexEnd, boolean inclusive, Class<T> bean, Session session, int offset) {
        return findByKeyAndIndex.findByKeyAndIndex(key,
    ...
    public <T, I> List<T> findByKeyAndIndexRange(Object key, I indexStart,
            I indexEnd, boolean inclusive, Class<T> bean, Session session,
            ConsistencyLevel consistency, int offset) {
        return findByKeyAndIndex.findByKeyAndIndex(key,
                indexStart, indexEnd, inclusive, bean, session, consistency, offset);
    }
	...
	public FindAllQuery getFindAllQuery() {
		return findAllQuery;
	}

	public FindByKeyQuery getFindByKeyQuery() {
	...
	public FindByIndexQuery getFindByIndexQuery() {
		return findByIndexQuery;
	}

	public FindByKeyAndIndexQuery getFindByKeyAndIndex() {
		return findByKeyAndIndex;
	}
	...
	public TruncateQuery getTruncateQuery() {
