...
public interface PersistenceAsync extends BasePersistence, PersistenceBuilder {
     ...
     * @param resultCallBack the callback is invoked after the function returns
     */
    <T, I> void findByIndex(String indexName, I index, Class<T> bean, int offset,
            ResultAsyncCallBack<List<T>> resultCallBack);
     ...
     * @param resultCallBack the callback is invoked after the function returns
     */
    <T, I> void findByIndex(I index, Class<T> bean, int offset, ResultAsyncCallBack<List<T>> resultCallBack);
     ...
     * @param consistency the consistency
     */
    <T, I> void findByIndex(I index, Class<T> bean, ConsistencyLevel consistency, 
    		ResultAsyncCallBack<List<T>> resultCallBack);
     ...
     * @param consistency the consistency
     */
    <T, I> void findByIndex(I index, Class<T> bean, ConsistencyLevel consistency, int offset, 
    		ResultAsyncCallBack<List<T>> resultCallBack);
