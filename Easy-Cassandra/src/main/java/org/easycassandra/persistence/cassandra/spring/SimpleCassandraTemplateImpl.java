...
public class SimpleCassandraTemplateImpl implements CassandraTemplate {
    ...
    public <T, I> List<T> findByIndex(String indexName, I index, Class<T> entity) {
        return findByIndex(indexName, index, entity, 0);
    }

	@Override
    public <T, I> List<T> findByIndex(String indexName, I index, Class<T> entity, int offset) {
        return command.findByIndex(indexName, index, entity, session, offset);
    }
    ...
    public <T, I> List<T> findByIndex(String indexName, I index,
        ...
        return findByIndex(indexName, index, entity, consistency, 0);
    }

	@Override
    public <T, I> List<T> findByIndex(String indexName, I index,
            Class<T> entity, ConsistencyLevel consistency, int offset) {
    ...
    public <T, I> List<T> findByKeyAndIndex(Object key, I index, Class<T> entity) {
        return command.findByKeyAndIndex(key, index, entity, session, 0);
    }
    ...
    public <T, I> List<T> findByKeyAndIndexRange(Object key, I indexStart,
        ...
        return command.findByKeyAndIndexRange(key, indexStart, indexEnd,
                exclusive, entity, session, consistency, 0);
    }
	...
	@Override
    public <T> CountBuilder<T> countBuilder(Class<T> classBean) {
        return builderPersistence.countBuilder(classBean);
    }
    ...
    @Override
	public RunCassandraCommand getRunCommand() {
		return command;
	}
}
