...
public interface Persistence extends BasePersistence, PersistenceBuilder  {
     ...
     * @return entities by index
     */
    <T, I> List<T> findByIndex(String indexName, I index, Class<T> bean, int offset);
     ...
     * @return entities by index
     */
    <T, I> List<T> findByIndex(I index, Class<T> bean, int offset);
     ...
     * @return entities by index
     */
    <T, I> List<T> findByKeyAndIndex(Object key, I index, Class<T> bean, int offset);
