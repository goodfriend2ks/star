...
public class SelectBuilderImpl <T> implements SelectBuilder<T> {
    ...
    @Override
	public SelectBuilder<T> withOffset(int offset) {
		this.offset = offset;
		return this;
	}
