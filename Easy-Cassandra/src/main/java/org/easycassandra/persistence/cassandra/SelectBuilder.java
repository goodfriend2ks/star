 ...
 * @param <T>
 */
public interface SelectBuilder<T> extends ClauseBuilder<SelectBuilder<T>, T> {
    /**
...
//    SelectBuilder<T> betweenExclusive(String name, Object startValue, Object endValue);
     ...
     * @return this
     */
   SelectBuilder<T> withOffset(int offset);
     /**
     ...
     */
    void executeAsync(ResultAsyncCallBack<List<T>> callBack);
}