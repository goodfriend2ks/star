...
import static org.springframework.data.mongodb.config.BeanNames.DB_FACTORY_BEAN_NAME;
import static org.springframework.data.mongodb.config.BeanNames.DEFAULT_CONVERTER_BEAN_NAME;
import static org.springframework.data.mongodb.config.BeanNames.INDEX_HELPER_BEAN_NAME;
import static org.springframework.data.mongodb.config.BeanNames.IS_NEW_STRATEGY_FACTORY_BEAN_NAME;
import static org.springframework.data.mongodb.config.BeanNames.MAPPING_CONTEXT_BEAN_NAME;
import static org.springframework.data.mongodb.config.BeanNames.VALIDATING_EVENT_LISTENER_BEAN_NAME;
