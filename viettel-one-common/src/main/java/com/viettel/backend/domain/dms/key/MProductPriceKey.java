...
import com.viettel.backend.domain.dms.MProductPrice;


@Embeddable
public class MProductPriceKey extends EOKey<UUID> {
	/**
	 * 
	 */
	...
	@Transient
	public static final String KEY_NAME = "m_ProductPrice_ID";
	
	@Column(name = MClient.CLIENT_KEYCOLUMN_NAME, nullable = false)
	private UUID ad_Client_ID;
	
	@Column(name = MProductPrice.KEYCOLUMN_NAME, nullable = false)
    private UUID m_ProductPrice_ID;
	
	public MProductPriceKey() {
		super();
	}

	public MProductPriceKey(UUID ad_Client_ID, UUID m_ProductPrice_ID) {
		super();
