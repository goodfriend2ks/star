...
@Embeddable
public class MConfigKey extends EOKey<UUID> {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7707895524863975195L;

	@Transient
	public static final String KEY_NAME = "ad_Config_ID";
	
	@Column(name = MClient.CLIENT_KEYCOLUMN_NAME, nullable = false)
	private UUID ad_Client_ID;
	
	@Column(name = MConfig.KEYCOLUMN_NAME, nullable = false)
    private UUID ad_Config_ID;
	
	public MConfigKey() {
		super();
	}

	public MConfigKey(UUID ad_Client_ID, UUID ad_Config_ID) {
		super();
