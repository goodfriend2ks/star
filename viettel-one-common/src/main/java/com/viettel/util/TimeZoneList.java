...
public class TimeZoneList {
    ...
    private List<Object> timeZonePairs = new ArrayList<Object>();
    ...
    private TimeZoneList() {
		...
		for (TimeZoneWithDisplayNames timeZone : timeZones) {
			timeZonePairs.add(new ValuePair<>(timeZone));
		}
    }
    ...
    public List<Object> getTimeZonePairs() {
    	return timeZonePairs;
    }
    
    public static final class TimeZoneWithDisplayNames implements IValuePair<String> {
    	/**
		 * 
		 */
		private static final long serialVersionUID = -5632702020489167018L;
