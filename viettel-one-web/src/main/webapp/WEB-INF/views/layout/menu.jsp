...
<ul class="sidebar-menu">
	...
	<li class="treeview">
	    ...
	    <ul class="treeview-menu">
	        <li><a href="${pageContext.request.contextPath}/admin/role"><i class="fa fa-angle-double-right"></i> Quy&#7873;n truy c&#7853;p</a></li>
	        <li><a href="${pageContext.request.contextPath}/admin/user"><i class="fa fa-angle-double-right"></i> Ng&#432;&#7901;i s&#7917; d&#7909;ng</a></li>
	...
	<li class="treeview">
	    <a href="#">
	        ...
	        <span class="link-title">Examples</span>
	        <i class="fa fa-angle-left pull-right"></i>
	    </a>
	    <ul class="treeview-menu">
