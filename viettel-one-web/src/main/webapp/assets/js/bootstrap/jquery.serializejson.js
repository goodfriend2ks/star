...
(function ($) {
  ...
  $.fn.serializeJSON = function (options) {
    ...
    $.each(formAsArray, function (i, input) {
      ...
      if (opts.parseWithFunction) value = opts.parseWithFunction(input, value); // allow for custom parsing
  ...
  $.serializeJSON = {
    ...
    parseValue: function(str, opts) {
      ...
      if (opts.parseBooleans && (str === "true" || str === "false" || str === "yes" || str === "no")) return (str === "true" || str === "yes"); // boolean
