$(function() {
	...
	$.fn.getMarker = function(id){
		...
		if(!$this.data('googleMap')) {
			if($this.data('googleDebug'))
				console.log("jQuery googleMap : Unable to file a marker where there is no map !");
			return null;
		}
		...
		if(typeof $markers[id] != 'undefined') {
			if($this.data('googleDebug'))
				console.log('jQuery googleMap : marker found');
			return $markers[id];
		} else {
			if($this.data('googleDebug'))
				console.error("jQuery googleMap : Unable to find a marker if it not exists !");
			return null;
		}
	},
	
	$.fn.moveMarker = function(id, coords){
		var $this = $(this);
